...
Here when sensor_1=0  detects the person, we are checking the detection of person at sensor_2 ,when the sensor_2=1 it means the person is about to enter the room and the value of total_people gets incremented and we will observe the sensor_2=0 when the person completely enters inside the room and also we will get the binary value of total_people entered in LED's.
